...
export const projects: Project[] = [
  {
    ...
    name: "CapyUniverse",
    description:
      "Plataforma que centraliza múltiplas ferramentas baseadas em IA em uma interface única, explorando design modular, experiência do usuário e integração de recursos",
  ...
  },
  {
    ...
    name: "CapyUNI - IDE",
    description:
      "IDE web moderna com persistência local e editor avançado no navegador, integrando Monaco Editor, armazenamento IndexedDB e base preparada para uso de IA",
  ...
  },
  {
    ...
    name: "Buscaki",
    description:
      "Catálogo estático de empresas com sistema de busca e filtros, focado em manipulação de dados locais, interface dinâmica no cliente e organização visual clara",
  ...
  },
  {
    ...
    name: "Genios",
    description:
      "Protótipo experimental de IA que permite conversas em linguagem natural com gênios históricos, explorando narrativa, interação e experiência conversacional",
    technologies: ["React", "TypeScript", "Vite"],
    demoUrl: "https://genios.pages.dev/",
    githubUrl: "https://github.com/faelscarpato/genios",
  },
  {
    id: "5",
    name: "CapyContrato Elite",
    description:
      "Aplicação que gera contratos personalizados com IA, permitindo compor cláusulas, ajustar o tom jurídico e visualizar o documento antes da exportação final",
    technologies: ["React", "TypeScript", "TailwindCSS", "Vite", "localStorage"],
    demoUrl: "https://capycontrato.pages.dev/",
    githubUrl: "https://github.com/faelscarpato/capycontrato",
  },
  {
    id: "6",
    name: "ReGift",
    description:
      "Plataforma web de troca e doação de itens com geolocalização, feed por proximidade, sistema de match e contato direto via WhatsApp em tempo real",
    technologies: [
      "Next.js (App Router)",
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    name: "CapyChart",
    description:
      "Webapp do ecossistema CapyUniverse para criação e visualização de gráficos interativos em tempo real, com layout responsivo e experiência visual capy-style.",
    technologies: ["React", "TypeScript", "TailwindCSS", "Vite", "Gemini API", "IndexedDB"],
    demoUrl: "https://capychart.pages.dev/",
  ...
  },
  {
    ...
    name: "DaVinci",
    description:
      "Assistente criativo que gera aplicações e códigos a partir de prompts, com modos variados de execução e suporte a anexos para enriquecer o contexto",
    technologies: ["React", "TypeScript", "TailwindCSS", "Vite", "Gemini API", "IndexedDB"],
  ...
  },
  {
    ...
    name: "FullSearchAI",
    description:
      "Assistente de pesquisa que utiliza Gemini para sintetizar informações de artigos e fontes online, permitindo ajustar complexidade, formato de resposta e idioma",
    technologies: ["React", "TypeScript", "TailwindCSS", "Vite", "Gemini API", "IndexedDB"],
  ...
  {
    id: "10",
    name: "Cardápio - LandingPage de Lanchonete",
    description:
      "Landing page de lanchonete com cardápio interativo e funcionalidade para envio automático de pedidos via WhatsApp, focada em uso rápido e direto.",
    technologies: ["HTML", "CSS", "JavaScript"],
...
export const blogPosts: BlogPost[] = [
  {
    ...
    summary:
      "Explorando padrões de design e melhores práticas para construir sistemas distribuídos resilientes e escaláveis usando arquitetura de microserviços.",
  },
  {
    id: "2",
    ...
    summary:
      "Um guia completo sobre como integrar gráficos 3D em aplicações web modernas, otimizando performance e criando experiências interativas imersivas.",
  },
  {
    id: "3",
    ...
    summary:
      "Como tRPC revoluciona o desenvolvimento full-stack TypeScript ao eliminar a necessidade de validação manual de tipos entre cliente e servidor.",
  },
  {
    id: "4",
    ...
    summary:
      "Técnicas avançadas de otimização incluindo memoização, code splitting, lazy loading e estratégias de renderização para aplicações React de alta performance.",
  },
  {
    id: "5",
    ...
    summary:
      "Guia prático para configurar pipelines de integração e entrega contínua usando GitHub Actions, desde testes automatizados até deploy em produção.",
  },
];
